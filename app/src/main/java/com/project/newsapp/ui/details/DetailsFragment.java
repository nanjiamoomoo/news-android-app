package com.project.newsapp.ui.details;
...
import com.project.newsapp.databinding.FragmentDetailsBinding;
...
public class DetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //get the passed article from SearchFragment and SaveFragment
        Article article = DetailsFragmentArgs.fromBundle(getArguments()).getArticle();

        //display the article on DetailsFragment
